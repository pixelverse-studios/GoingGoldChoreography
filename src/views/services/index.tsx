...
const SignUpButton = ({ onClick }: { onClick: () => void }) => {
  return (
    <button onClick={onClick} className="callToAction">
      Sign Up Now
    </button>
  )
}
...
const Offerings = () => {
  ...
  return (
    <>
      <ul className={styles.offerings}>
        <li>
          ...
          <div className={styles.descriptor}>
            <p>
              Full routine custom choreography from inception to instruction
            </p>
            <ul>
              <li>
                <FaCheckCircle />
              ...
              <li>
                <FaCheckCircle />
                <span>
                  1 year of virtual support throughout competition season
                </span>
              </li>
              <li>
                <FaCheckCircle />
        ...
        <li>
          ...
          <div className={styles.descriptor}>
            <p>
              Need a clean-up of your finished routine? This package is designed
              as a consulting session to
            </p>
            <ul>
              <li>
                <FaCheckCircle />
      ...
      <CallToAction show={opened} onClose={close} />
    </>
  )
}
