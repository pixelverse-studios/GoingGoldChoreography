        ...
        <div className={styles.homePage}>
          <section className={styles.hero}>
            ...
            <p>
              ...
              School, Collegiate, and All-Star. Our commitment is not only
              supplying you with a custom routine to match your skillset, but to
              give you a GOLD level experience from start to finish.
            </p>
